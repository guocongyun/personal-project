from transformers import AlbertModel, AlbertPreTrainedModel, AutoModelForMaskedLM, AutoModel
...
#         self.albert = AutoModel.from_pretrained(config=config)
    ...
    def forward(
        ...
        # Extracting features from Albert
...
class DistillBertMult(torch.nn.Module):
    def __init__(self, config, custom_hidden_act=False, pretrained_path="albert-base-uncased"):
        super().__init__()
        self.albert = AlbertModel.from_pretrained(pretrained_path, config=config)
        self.hidden_act = nn.ReLU()
        if custom_hidden_act == "geglu":
            for i in range(len(self.albert.encoder.layer)):
                self.albert.encoder.layer[i].intermediate.act_fn = GEGLU()
...
class AlbertForToken(torch.nn.Module):
    def __init__(self, config, custom_hidden_act=False, pretrained_path="albert-base-uncased"):
        super().__init__()
        self.albert = AlbertModel.from_pretrained(pretrained_path, config=config)
        self.hidden_act = nn.ReLU()
...
class AlbertForBinMult(torch.nn.Module):
    def __init__(self, config, custom_hidden_act=False, pretrained_path="albert-base-uncased"):
        super().__init__()
        self.albert = AlbertModel.from_pretrained(pretrained_path, config=config)
        self.hidden_act = nn.ReLU()
...
class AlbertForBinMultToken(torch.nn.Module):
    def __init__(self, config, custom_hidden_act=False, pretrained_path="albert-base-uncased"):
        super().__init__()
        self.albert = AlbertModel.from_pretrained(pretrained_path)
        self.hidden_act = nn.ReLU()
        if custom_hidden_act == "geglu":
            for i in range(len(self.albert.encoder.layer)):
                self.albert.encoder.layer[i].intermediate.act_fn = GEGLU()
...
class AlbertForBinMultTokenFreeze(torch.nn.Module):
    def __init__(self, config, custom_hidden_act=False, pretrained_path="albert-base-uncased"):
        super().__init__()
        self.albert = AlbertModel.from_pretrained(pretrained_path, config=config)
        self.hidden_act = nn.ReLU()
...
class AlbertForBinMultTokenKNN(torch.nn.Module):
    def __init__(self, config, custom_hidden_act=False, pretrained_path="albert-base-uncased"):
        super().__init__()
        self.albert = AlbertModel.from_pretrained(pretrained_path, config=config)
        self.hidden_act = nn.ReLU()
...
class AlbertForBinMultTokenLearnLoss(torch.nn.Module):
    def __init__(self, config, custom_hidden_act=False, pretrained_path="albert-base-uncased"):
        super().__init__()
        self.albert = AlbertModel.from_pretrained(pretrained_path, config=config)
        self.hidden_act = nn.ReLU()
...
class AlbertForBinMultTokenLoss(torch.nn.Module):
...
#     def __init__(self):
#         super().__init__()
#         self.albert = AlbertModel.from_pretrained('albert-base-uncased', config=config)
